...
<asp:Content ID="BarContent" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <!-- BEGIN Theme Setting -->
    ...
    <div class="container-fluid" id="main-container">
        ...
        <div id="main-content">
            ...
            <div class="box">
                <div class="box-title">
                    <h3><i class="icon-tasks"></i>iNetworks Vs Competitors</h3>
                    <div class="box-tool">
    ...
    <script>
        $(function () {
            $('#container').highcharts({
                ...
                xAxis: {
                    categories: ['IT Suppoprt', 'Network and App', 'Cloud Services']
                },
                yAxis: {
                    title: {
                        text: 'Efficiency'
    ...
    <%--<script src="code/assets/flot/jquery.flot.resize.js"></script>Culprit of jQuery--%>
